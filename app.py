...
with st.sidebar:
    ...
    st.markdown('<div style="font-size:0.75rem;color:var(--muted);text-align:center">Federation MMJ<br><span style="color:var(--gold)">2026</span></div>', unsafe_allow_html=True)
